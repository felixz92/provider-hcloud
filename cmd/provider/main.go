...
import (
	...
	"github.com/felixz92/provider-hcloud/apis/v1alpha1"
	"github.com/felixz92/provider-hcloud/config"
	"github.com/felixz92/provider-hcloud/internal/clients"
	"github.com/felixz92/provider-hcloud/internal/controller"
	"github.com/felixz92/provider-hcloud/internal/features"
)

func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for HetznerCloud").DefaultEnvars()
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add HetznerCloud APIs to scheme")
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup HetznerCloud controllers")
